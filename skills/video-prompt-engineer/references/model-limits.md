...
| PixVerse | 2048 characters on most endpoints, 5000 on some | 2048 characters | Vendor's own testing reports control dropping past 80 words |
...
| PixVerse | 2048 characters | 50 to 80 words |
...
- **A separate negative field is free budget.** Kling gives the negative prompt its own 2500
  characters, so exclusions moved there cost nothing against the prompt. PixVerse does the same at
  2048. Where a model has no negative field, the exclusions come out of the prompt budget and
  belong last.
